...
if (!JWT_SECRET) {
  if (process.env.NODE_ENV !== 'production') {
    JWT_SECRET = 'secretjwtpasswordfordevonly';
    console.log('Missing env var JWT SECRET, Using unsafe dev secret.');
  } else {
    console.log('Missing env var JWT SECRET. Authentication disabled.');
  }
}
